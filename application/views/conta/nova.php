<div id="content-container">
    ...
    <div id="content">
        ...
        <div id="body">
            ...
            <?php
            echo form_open('/conta/grava_nova');
            ...
            echo "<br/>";
            echo form_dropdown(
                    'banco_id', $bancos, set_value('banco_id')
            );
            echo "</p>";
            ...
            echo "<br/>";
            echo form_input(array('name' => 'num_agencia', 'id' => 'num_agencia', 'size' => '5', 'maxlength' => '5', 'value' => set_value('num_agencia')));
            echo form_input(array('name' => 'ag_digito', 'id' => 'ag_digito', 'size' => '2', 'maxlength' => '2', 'value' => set_value('ag_digito')));
            echo "</p>";
            
            echo "<p>";
            echo form_label('Conta', 'num_conta');
            echo "<br/>";
            echo form_input(array('name' => 'num_conta', 'id' => 'num_conta', 'size' => '8', 'maxlength' => '8', 'value' => set_value('num_conta')));
            echo form_input(array('name' => 'conta_digito', 'id' => 'conta_digito', 'size' => '2', 'maxlength' => '2', 'value' => set_value('conta_digito')));
            echo "</p>";
            
            echo "<p>";
            echo form_label('Saldo', 'saldo');
            echo "<br/>";
            echo form_input(array('name' => 'saldo', 'id' => 'saldo', 'size' => '13', 'maxlength' => '13', 'class'=>'reais', 'value' => set_value('saldo')));
            echo "</p>";
            
            echo "<p>";
            echo form_label('Limite', 'limite');
            echo "<br/>";
            echo form_input(array('name' => 'limite', 'id' => 'limite', 'size' => '13', 'maxlength' => '13', 'class'=>'reais', 'value' => set_value('limite')));
            echo "</p>";
